...
import { SIP01_SCHEMA_STATEMENTS, SERVICE_SCHEMA_STATEMENTS, SCHEMA_VERSION, migrationV7Statements, migrationV8Statements, migrationV9Statements, migrationV10Statements, migrationV11Statements, CACHED_TAG_NAMES } from './sip01/schema';
    ...
    try {
      ...
      if (url.pathname === "/") {
        if (request.headers.get("Upgrade") === "websocket") {
          ...
          // Client IP flows to the DO for per-IP federation budgets (NIP-77).
